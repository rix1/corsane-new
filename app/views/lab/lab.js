...
angular.module('myApp.lab', ['ui.router'])
	...
	.controller('adminCtrl', ['$state', '$rootScope', '$scope', 'topicService','articleService', 'paragraphService', function($state, $rootScope, $scope, topicService, articleService, paragraphService) {
		$scope.topics = {};
